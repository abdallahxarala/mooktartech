-- ============================================================================
-- Migration: Ajouter colonne payment_method à la table exhibitors
-- Date: 2025-02-02
-- Description: Ajoute la colonne payment_method pour stocker la méthode de paiement choisie
-- ============================================================================
...
-- 4. Vérifier que la colonne existe (pour debug)
