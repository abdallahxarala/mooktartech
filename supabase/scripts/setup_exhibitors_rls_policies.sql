-- ============================================================================
-- Script SQL pour configurer les politiques RLS sur la table exhibitors
-- Permet l'inscription publique des exposants
...
-- 3. Créer une politique pour permettre les inscriptions publiques
...
-- 4. Politique pour que les admins voient tout
...
-- 5. Politique pour que les exposants voient leur propre inscription
...
-- 6. Politique pour que les exposants puissent mettre à jour leur propre inscription
