...
export default function CartPage() {
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-3xl p-12 shadow-xl text-center">
              ...
              <p className="text-gray-600 mb-8 text-lg">Découvrez nos imprimantes professionnelles et accessoires</p>
              <Link
                href="/fr/products"
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-32 pb-20">
      <div className="container mx-auto px-6">
        <div className="mb-8">
          <Link href="/fr/products" className="inline-flex items-center gap-2 text-gray-600 hover:text-orange-500 font-semibold mb-4 transition-colors">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div key={item.id} className="bg-white rounded-2xl p-6 shadow-lg border-2 border-gray-100 hover:border-orange-500 transition-all">
                <div className="flex gap-6">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <Link href={item.slug ? `/fr/products/${item.slug}` : '#'} className="text-xl font-black text-gray-900 hover:text-orange-500 transition-colors line-clamp-2 mb-3">
                      {item.name}
                    </Link>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-gray-100 sticky top-32">
              ...
              <Link href="/fr/checkout" className="flex items-center justify-center gap-2 w-full px-8 py-5 bg-gradient-to-r from-orange-500 to-pink-500 text-white text-lg font-black rounded-xl hover:from-orange-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl hover:scale-105 mb-4">
                <span>Passer la commande</span>
                <ArrowRight className="w-5 h-5" />
              </Link>
              <Link href="/fr/products" className="block text-center px-8 py-4 border-2 border-gray-200 text-gray-700 font-bold rounded-xl hover:border-orange-500 hover:text-orange-500 hover:bg-orange-50 transition-all">
