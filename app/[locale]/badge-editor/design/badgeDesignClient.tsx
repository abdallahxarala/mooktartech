...
interface BadgeDesignClientProps {
  locale: string
  translations: any
}

export function BadgeDesignClient({ locale, translations }: BadgeDesignClientProps) {
  const {
    currentProject,
    canvasMode,
    activeTool,
  ...
  }, [currentProject, createProject, isInitialized])
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-6 py-3">
          <Link 
            href={`/${locale}/badge-editor/events`}
