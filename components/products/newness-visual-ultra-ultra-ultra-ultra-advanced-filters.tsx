...
export default function NewnessVisualUltraUltraUltraUltraAdvancedFilters() {
  ...
  return (
    <div className="mb-6">
      ...
      <div className="space-y-2">
        <button className="w-full flex items-center gap-3 px-3 py-2 text-sm bg-orange-100 text-orange-700 rounded-lg transition-colors hover:bg-orange-200 border-2 border-orange-500">
